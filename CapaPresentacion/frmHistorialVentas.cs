    ...
    public partial class frmHistorialVentas : Form
    {
        ...
        private void frmHistorialVentas_Load(object sender, EventArgs e)
        {
            ...
            foreach (Venta item in lista)
            {
                ...
                item.TipoDocumento, item.NumeroDocumento, item.DocumentoCliente, item.NombreCliente,
                item.MontoTotal, });
            }
        }
        ...
        private void btnverdetallecompra_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    using (var modal = new frmDetalleVentas(Convert.ToInt32(txtnumerodocumento.Text)))
                    {
